...
def main():
    all_champs = {}
    data = requests.get("https://raw.githubusercontent.com/GuardToad/testing/main/latest/plugins/rcp-fe-lol-champion-statistics/global/default/rcp-fe-lol-champion-statistics.js")
